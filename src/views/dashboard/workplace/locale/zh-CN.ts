export default {
  ...
  'workplace.onlineContent': '总内容',
  'workplace.putIn': '投放中内容',
  'workplace.newDay': '日新增评论',
  'workplace.sms': '包含短信',
  'workplace.daily': '包含语音',
  'workplace.phonetoal': '包含手机',
  ...
  'workplace.popularContent.sms': '短信',
  'workplace.popularContent.phone': '手机',
  'workplace.popularContent.daily': '语音',
